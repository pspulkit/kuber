...
def perform_request():
    print("streak_volume_shockers_scanner::started")
    try:
        ...
        output_filename = os.path.abspath("reports/streak-volume-deals-latest.csv")
        merged_df.to_csv(output_filename)
        print("streak_volume_shockers_scanner::completed")
